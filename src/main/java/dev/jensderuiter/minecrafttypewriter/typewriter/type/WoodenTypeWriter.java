...
public class WoodenTypeWriter extends BaseTypeWriter {
    ...
    public HashMap<String, Vector> getKeyboardLayout() {
        ...
        textures.put("enter", new Vector(1, 0, 0));
        textures.put("a", new Vector(-0.80, 0, 0));
        textures.put("b", new Vector(0.10, 0, 0.2));
        textures.put("c", new Vector(-0.30, 0, 0.2));
        textures.put("d", new Vector(-0.40, 0, 0));
        textures.put("e", new Vector(-0.45, 0, -0.2));
        textures.put("f", new Vector(-0.20, 0, 0));
        textures.put("g", new Vector(0, 0, 0));
        textures.put("h", new Vector(0.20, 0, 0));
        textures.put("i", new Vector(0.55, 0, -0.2));
        textures.put("j", new Vector(0.40, 0, 0));
        textures.put("k", new Vector(0.60, 0, 0));
        textures.put("l", new Vector(0.80, 0, 0));
        textures.put("m", new Vector(0.50, 0, 0.2));
        textures.put("n", new Vector(0.30, 0, 0.2));
        textures.put("o", new Vector(0.75, 0, -0.2));
        textures.put("p", new Vector(0.95, 0, -0.2));
        textures.put("q", new Vector(-0.85, 0, -0.2));
        textures.put("r", new Vector(-0.25, 0, -0.2));
        textures.put("s", new Vector(-0.60, 0, 0));
        textures.put("t", new Vector(-0.05, 0, -0.2));
        textures.put("u", new Vector(0.35, 0, -0.2));
        textures.put("v", new Vector(-0.10, 0, 0.2));
        textures.put("w", new Vector(-0.65, 0, -0.2));
        textures.put("x", new Vector(-0.50, 0, 0.2));
        textures.put("y", new Vector(0.15, 0, -0.2));
        textures.put("z", new Vector(-0.70, 0, 0.2));
        textures.put(".", new Vector(0.90, 0, 0.2));
        textures.put(",", new Vector(0.70, 0, 0.2));
        return textures;
    }
